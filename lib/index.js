...
var restMethods = ['get', 'post', 'put', 'options', 'delete'];
/**
...
function encodeOptions(options) {
    ...
    return __assign({}, clonedOptions, { rules: encodedRules });
}
    ...
    MockeryClient.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, navigator.serviceWorker.register(this.options.serviceWorkerFilepath, { scope: '/' })
                        .then(function (reg) {
